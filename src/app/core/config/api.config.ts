...
export const API = {
  ...
  RENTALS: {
    ...
    START: (id: number | string) => `${BASE_URL}/rentals/${id}/start`,
    CANCEL: (id: number | string) => `${BASE_URL}/rentals/${id}/cancel`,
    UNITS: (id: number | string) => `${BASE_URL}/rentals/${id}/units`,
    HISTORY: (id: number | string) => `${BASE_URL}/rentals/${id}/history`,
    ITEM_AVAILABILITY: (itemId: number | string) => `${BASE_URL}/rentals/availability/items/${itemId}`,
    AVAILABLE_UNITS: (itemId: number | string) => `${BASE_URL}/rentals/availability/items/${itemId}/units`,
