...
@Component({
  selector: 'app-payable-payment-charges-modal',
  templateUrl: './payable-payment-charges-modal.component.html',
  styleUrls: ['./payable-payment-charges-modal.component.css'],
})
export class PayablePaymentChargesModalComponent implements OnChanges {
  @Input() visible = false;
  @Input() lateFee = 0;
